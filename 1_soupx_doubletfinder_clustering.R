...
cellrangerFolder="../novogene/Result_X202SC21091831-Z01-F027_mm10/1.Data_process/"
...
opfn <- paste0(outFolder,"sc.NormByLibrary.cellclassify_newfilter-res0.5.",Sys.Date(),".rds") 
write_rds(sc, opfn)

fname=paste0(outFolder,"/UMAP_Harmony-res0.5.png");
