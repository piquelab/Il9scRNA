...
sc <- readRDS("~/rs_grp_il9/3_harmony_cellClass_Murine2023_Roger/sc_harmony_cellClass_Murine2023.res0.2.rds")

outFolder="~/rs_grp_il9/Il9scRNA/4_celltypeDGE_IL9_DL/"
